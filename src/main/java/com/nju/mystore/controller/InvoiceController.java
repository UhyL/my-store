...
public class InvoiceController {
    ...
    public ResultVO<Integer> addCoupon(@RequestParam("invoiceId") Integer invoiceId, @RequestParam("couponId") Integer couponId) {
        Log.record_log("addCoupon" + " "
                + "invoiceId=" + invoiceId + " "
                + "couponId=" + couponId);
        return ResultVO.buildSuccess(couponService.addCoupon(invoiceId, couponId));
    }
    ...
    @GetMapping("/getAllCoupons/{invoiceId}")
    public ResultVO<List<CouponVO>> getAllCoupons(@PathVariable("invoiceId") Integer invoiceId) {
        Log.record_log("getAllCoupons" + " " + "invoiceId=" + invoiceId);
        return ResultVO.buildSuccess(couponService.getAllCouponsByInvoice(invoiceId));
    }
